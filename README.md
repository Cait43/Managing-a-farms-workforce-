The following are instructions on running a local instance of the website on the computer labs or ones personal machine. Guidance for installing prerequisites on ones personal machine is not provided.
